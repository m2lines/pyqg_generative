...
for operator in ['Operator1-64', 'Operator2-64']:
    for model in ['OLSModel', 'MeanVarModel', 'CGANRegression']:
        train_path = '/scratch/pp2681/pyqg_generative/Reference-Default-scaled/eddy/' + operator
        transfer_path = '/scratch/pp2681/pyqg_generative/Reference-Default-scaled/jet/' + operator
